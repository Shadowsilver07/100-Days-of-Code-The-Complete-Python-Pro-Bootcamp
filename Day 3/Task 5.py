...
# 1
'''
# if / elif / else - only execute once condition is met
# Only 1 will be carried out
if condition1:
    do A
elif condition2:
    do B
...
# Multiple if - execute everytime condition is true
# All 3 will be carries out if condition is met
...
# 3 - Task see picture 5 for the instrutctions
