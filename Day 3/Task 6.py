...
if height >= 120:
    ...
    if age < 12:
        ...
        bill = 7
        print("Youth tickets are $7.")
    elif age >= 45 and age <= 55: # added here see picture 6, this can also be simplified | elif age >= 45 age <= 55:
        bill = 0
        print("Midlife tickets are $0.") # print("Everything is going to be ok. Have a free ride on us!")
    else:
        bill = 12
        print("Adult tickets are $12.")
